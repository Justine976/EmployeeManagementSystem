 ...
 * @author Admin
 */
public class TimeInOutPanel extends javax.swing.JPanel implements Runnable, ThreadFactory {
    ...
    /**
     * Creates new form TimeInOutPanel
     */
    public TimeInOutPanel(MainFrame mainFrame) {
    ...
    public void timeInOut() {
        try {
            ...
            if (rs.next()) {
                ...
                pstmt = mainFrame.connection.prepareStatement(checkQuery);
                pstmt.setString(1, employeeId);
                ...
                if (!rs.next()) {
                    ...
                    pstmt = mainFrame.connection.prepareStatement(insertQuery);
                    pstmt.setString(1, employeeId);
                    pstmt.setString(2, today.toString());
                    pstmt.setString(3, now.format(DateTimeFormatter.ofPattern("HH:mm:ss")));
                    ...
                    if (timeOutStr == null) {
                        ...
                        LocalTime tIn = LocalTime.parse(timeInStr);
                        LocalTime tOut = now;
                        ...
                        pstmt = mainFrame.connection.prepareStatement(updateQuery);
                        pstmt.setString(1, now.format(DateTimeFormatter.ofPattern("HH:mm:ss")));
            ...
            Logger.getLogger(TimeInOutPanel.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        add(timeInOutHeaderLabel, java.awt.BorderLayout.PAGE_START);

        centerPanel.setOpaque(false);
        centerPanel.setPreferredSize(new java.awt.Dimension(700, 500));
    ...
    private void backButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backButtonActionPerformed
        if (JOptionPane.showConfirmDialog(this, "Are you sure you want to go Back?",
            ...
            mainFrame.switchPanel(new LoginPanel(mainFrame), "Login Panel");
